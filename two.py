...
with mp_pose.Pose(min_detection_confidence=0.7, min_tracking_confidence=0.7) as pose:
    while cap.isOpened():
        ...
        try:
            ...
            if angle_left_shoulder < 30 and angle_left_elbow > 80 and (stage == '' or stage == "right punch"):
                stage = "left punch"
                counter += 1
            if angle_right_shoulder < 30 and angle_right_elbow > 80 and (stage == '' or stage == "left punch"):
                stage = "right punch"
                counter += 1
